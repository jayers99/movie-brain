...
- A model switch is a re-embed of 5,052 films on CPU (measured 44 s with mpnet) and a 420 MB download shared with nothing (MiniLM's cache is shared with yt-brain; mpnet's would not be). Declining it costs nothing.
